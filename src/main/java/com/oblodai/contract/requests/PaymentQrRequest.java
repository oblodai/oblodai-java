...
public final class PaymentQrRequest {
    ...
    /** Sets {@code order_id}. */
    public PaymentQrRequest orderId(String value) {
        this.orderId = value;
        return this;
    }
    ...
    /** Sets {@code uuid}. */
    public PaymentQrRequest uuid(String value) {
        this.uuid = value;
        return this;
    }

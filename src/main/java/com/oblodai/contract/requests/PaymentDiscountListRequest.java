...
/**
 * Body of {@code POST /v1/payment/discount/list}.
 *
 * <p>Fluent setters; unset fields are omitted from the JSON, never sent as null.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public final class PaymentDiscountListRequest {
    ...
    /** Sets {@code limit}. */
    public PaymentDiscountListRequest limit(Integer value) {
        this.limit = value;
        return this;
    }
    ...
    /** Sets {@code offset}. */
    public PaymentDiscountListRequest offset(Integer value) {
        this.offset = value;
        return this;
    }

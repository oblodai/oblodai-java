...
/**
 * Body of {@code POST /v1/webhooks/deliveries}.
 *
 * <p>Fluent setters; unset fields are omitted from the JSON, never sent as null.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public final class WebhooksDeliveriesRequest {
    ...
    /** Sets {@code limit}. */
    public WebhooksDeliveriesRequest limit(Integer value) {
        this.limit = value;
        return this;
    }
    ...
    /** Sets {@code offset}. */
    public WebhooksDeliveriesRequest offset(Integer value) {
        this.offset = value;
        return this;
    }

...
public final class PayoutLinkRequest {
    ...
    /** Your deduplication key, unique per merchant; the Idempotency-Key header has no effect on this endpoint. Example: {@code bonus-42}. */
    ...
    /** Sets {@code amount}. */
    public PayoutLinkRequest amount(String value) {
        this.amount = value;
        return this;
    }
    ...
    /** Sets {@code currency}. */
    public PayoutLinkRequest currency(String value) {
        this.currency = value;
        return this;
    }
    ...
    /** Sets {@code email}. */
    public PayoutLinkRequest email(String value) {
        this.email = value;
        return this;
    }
    ...
    public PayoutLinkRequest expiresInSeconds(Integer value) {
    ...
    public PayoutLinkRequest feeBearer(String value) {
        this.feeBearer = value;
        return this;
    }

    /** Sets {@code fee_bearer} from the generated vocabulary. */
    public PayoutLinkRequest feeBearer(FeeBearer value) {
    ...
    /** Sets {@code network}. */
    public PayoutLinkRequest network(String value) {
        this.network = value;
        return this;
    }

    /** Sets {@code network} from the generated vocabulary. */
    public PayoutLinkRequest network(Network value) {
    ...
    /** Sets {@code note}. */
    public PayoutLinkRequest note(String value) {
        this.note = value;
        return this;
    }
    ...
    /** Sets {@code passcode}. */
    public PayoutLinkRequest passcode(String value) {
        this.passcode = value;
        return this;
    }
    ...
    /** Sets {@code reference}. */
    public PayoutLinkRequest reference(String value) {
    ...
    /** Sets {@code title}. */
    public PayoutLinkRequest title(String value) {
        this.title = value;
        return this;
    }

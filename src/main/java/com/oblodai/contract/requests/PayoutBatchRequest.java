...
public final class PayoutBatchRequest {
    ...
    /** Array of 1 to 5000 items — the same fields as POST /v1/payout; order_id is required on every item and serves as the idempotency key: a repeat returns the already created payout. Required. */
    @JsonProperty("payouts")
    private List<Payout> payouts;

    /** Sets {@code on_error}. */
    public PayoutBatchRequest onError(String value) {
        this.onError = value;
        return this;
    }

    /** Sets {@code on_error} from the generated vocabulary. */
    public PayoutBatchRequest onError(BatchOnError value) {
    ...
    /** Sets {@code payouts}. */
    public PayoutBatchRequest payouts(List<Payout> value) {
        this.payouts = value;
        return this;
    }

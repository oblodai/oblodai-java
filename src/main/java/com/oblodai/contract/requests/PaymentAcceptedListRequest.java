...
/**
 * Body of {@code POST /v1/payment/accepted/list}.
 *
 * <p>Fluent setters; unset fields are omitted from the JSON, never sent as null.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public final class PaymentAcceptedListRequest {
    ...
    /** Sets {@code limit}. */
    public PaymentAcceptedListRequest limit(Integer value) {
        this.limit = value;
        return this;
    }
    ...
    /** Sets {@code offset}. */
    public PaymentAcceptedListRequest offset(Integer value) {
        this.offset = value;
        return this;
    }

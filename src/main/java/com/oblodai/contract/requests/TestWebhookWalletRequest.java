...
/**
 * Body of {@code POST /v1/test-webhook/wallet}.
 *
 * <p>Fluent setters; unset fields are omitted from the JSON, never sent as null.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public final class TestWebhookWalletRequest {
    ...
    /** Status in the body — from the status dictionary of this event type. Default paid (confirmed for a payout). Example: {@code paid}. One of "paid". */
    @JsonProperty("status")
    ...
    /** Sets {@code currency}. */
    public TestWebhookWalletRequest currency(String value) {
        this.currency = value;
        return this;
    }
    ...
    /** Sets {@code network}. */
    public TestWebhookWalletRequest network(String value) {
        this.network = value;
        return this;
    }

    /** Sets {@code network} from the generated vocabulary. */
    public TestWebhookWalletRequest network(Network value) {
    ...
    /** Sets {@code order_id}. */
    public TestWebhookWalletRequest orderId(String value) {
        this.orderId = value;
        return this;
    }
    ...
    /** Sets {@code status}. */
    public TestWebhookWalletRequest status(String value) {
        this.status = value;
        return this;
    }
    ...
    public TestWebhookWalletRequest urlCallback(String value) {
    ...
    /** Sets {@code uuid}. */
    public TestWebhookWalletRequest uuid(String value) {
        this.uuid = value;
        return this;
    }

...
/**
 * Query parameters of {@code GET /v1/documents/referrals}.
 *
 * <p>Build one with {@link #builder()}; fields the SDK does not know yet are kept in
 * {@link #extra()} and sent back as they came.
 */
public final class GetReferralsDocumentQuery implements WireObject {
    ...
    private GetReferralsDocumentQuery(Builder builder) {
     ...
     */
    public static GetReferralsDocumentQuery fromMap(Map<String, ?> data) {
        Builder builder = new Builder();
        builder.from = Wire.optional(data, "from", Wire::string, "GetReferralsDocumentQuery");
        builder.to = Wire.optional(data, "to", Wire::string, "GetReferralsDocumentQuery");
        builder.lang = Wire.optional(data, "lang", Wire::string, "GetReferralsDocumentQuery");
        builder.format = Wire.optional(data, "format", Wire::string, "GetReferralsDocumentQuery");
        builder.nulls.addAll(Wire.nulls(data, FIELDS));
        builder.extra.putAll(Wire.extra(data, FIELDS));
        return new GetReferralsDocumentQuery(builder);
    }
     ...
     */
    public static GetReferralsDocumentQuery fromJson(Object data) {
        return fromMap(Wire.object(data, "GetReferralsDocumentQuery"));
    }
    ...
    public boolean equals(Object other) {
        return other instanceof GetReferralsDocumentQuery that
    ...
    /** Builds a {@link GetReferralsDocumentQuery}. */
    public static final class Builder {
        ...
        /**
         * @return the {@link GetReferralsDocumentQuery}
         */
        public GetReferralsDocumentQuery build() {
            return new GetReferralsDocumentQuery(this);
        }
    }
}

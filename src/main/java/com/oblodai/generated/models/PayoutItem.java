 ...
 */
public final class PayoutItem implements WireObject {
    ...
    private final Map<String, Object> convert;
    ...
    private PayoutItem(Builder builder) {
     ...
     */
    public static PayoutItem fromMap(Map<String, ?> data) {
        Builder builder = new Builder();
        builder.address = Wire.required(data, "address", Wire::string, "PayoutItem");
        builder.amount = Wire.required(data, "amount", Wire::decimal, "PayoutItem");
        builder.approvalRequired = Wire.required(
                data, "approval_required", Wire::bool, "PayoutItem");
        builder.commission = Wire.required(data, "commission", Wire::decimal, "PayoutItem");
        builder.convert = Wire.optional(data, "convert", Wire.mapOf(Wire::any), "PayoutItem");
        builder.createdAt = Wire.required(data, "created_at", Wire::string, "PayoutItem");
        builder.currency = Wire.required(data, "currency", Wire::string, "PayoutItem");
        builder.documentUrl = Wire.required(data, "document_url", Wire::string, "PayoutItem");
        builder.feeBearer = Wire.required(
                data, "fee_bearer", PayoutFeeBearer::fromJson, "PayoutItem");
        builder.isFinal = Wire.required(data, "is_final", Wire::bool, "PayoutItem");
        builder.isRefund = Wire.required(data, "is_refund", Wire::bool, "PayoutItem");
        builder.memo = Wire.required(data, "memo", Wire::string, "PayoutItem");
        builder.network = Wire.required(data, "network", Wire::string, "PayoutItem");
        builder.orderId = Wire.optional(data, "order_id", Wire::string, "PayoutItem");
        builder.payerAmount = Wire.required(data, "payer_amount", Wire::decimal, "PayoutItem");
        builder.paymentOrderId = Wire.optional(
                data, "payment_order_id", Wire::string, "PayoutItem");
        builder.refundFor = Wire.optional(data, "refund_for", Wire::string, "PayoutItem");
        builder.source = Wire.required(data, "source", PayoutSource::fromJson, "PayoutItem");
        builder.status = Wire.required(data, "status", PayoutStatus::fromJson, "PayoutItem");
        builder.txid = Wire.required(data, "txid", Wire::string, "PayoutItem");
        builder.updatedAt = Wire.required(data, "updated_at", Wire::string, "PayoutItem");
        builder.uuid = Wire.required(data, "uuid", Wire::string, "PayoutItem");
        builder.nulls.addAll(Wire.nulls(data, FIELDS));
        builder.extra.putAll(Wire.extra(data, FIELDS));
        return new PayoutItem(builder);
    }
     ...
     */
    public static PayoutItem fromJson(Object data) {
        return fromMap(Wire.object(data, "PayoutItem"));
    }
    ...
    public Map<String, Object> toMap() {
        ...
        Wire.put(out, "convert", this.convert, this.nulls);
    ...
    public static final class Builder {
         ...
         * @return this builder
         */
        public Builder convert(Map<String, Object> convert) {
            this.convert = Wire.copyMap(convert);
            return this;
        }
        ...
        /**
         * @return the {@link PayoutItem}
         * @throws IllegalStateException when a required field is not set
         */
        public PayoutItem build() {
            Wire.require(this.address, "PayoutItem", "address");
            Wire.require(this.amount, "PayoutItem", "amount");
            Wire.require(this.approvalRequired, "PayoutItem", "approval_required");
            Wire.require(this.commission, "PayoutItem", "commission");
            Wire.require(this.createdAt, "PayoutItem", "created_at");
            Wire.require(this.currency, "PayoutItem", "currency");
            Wire.require(this.documentUrl, "PayoutItem", "document_url");
            Wire.require(this.feeBearer, "PayoutItem", "fee_bearer");
            Wire.require(this.isFinal, "PayoutItem", "is_final");
            Wire.require(this.isRefund, "PayoutItem", "is_refund");
            Wire.require(this.memo, "PayoutItem", "memo");
            Wire.require(this.network, "PayoutItem", "network");
            Wire.require(this.payerAmount, "PayoutItem", "payer_amount");
            Wire.require(this.source, "PayoutItem", "source");
            Wire.require(this.status, "PayoutItem", "status");
            Wire.require(this.txid, "PayoutItem", "txid");
            Wire.require(this.updatedAt, "PayoutItem", "updated_at");
            Wire.require(this.uuid, "PayoutItem", "uuid");
            return new PayoutItem(this);
        }
    }
}

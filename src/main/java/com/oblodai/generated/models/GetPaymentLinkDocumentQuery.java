...
/**
 * Query parameters of {@code GET /v1/documents/link}.
 *
 * <p>Build one with {@link #builder()}; fields the SDK does not know yet are kept in
 * {@link #extra()} and sent back as they came.
 */
public final class GetPaymentLinkDocumentQuery implements WireObject {
    ...
    private GetPaymentLinkDocumentQuery(Builder builder) {
     ...
     */
    public static GetPaymentLinkDocumentQuery fromMap(Map<String, ?> data) {
        Builder builder = new Builder();
        builder.uuid = Wire.required(data, "uuid", Wire::string, "GetPaymentLinkDocumentQuery");
        builder.from = Wire.optional(data, "from", Wire::string, "GetPaymentLinkDocumentQuery");
        builder.to = Wire.optional(data, "to", Wire::string, "GetPaymentLinkDocumentQuery");
        builder.lang = Wire.optional(data, "lang", Wire::string, "GetPaymentLinkDocumentQuery");
        builder.format = Wire.optional(data, "format", Wire::string, "GetPaymentLinkDocumentQuery");
        builder.nulls.addAll(Wire.nulls(data, FIELDS));
        builder.extra.putAll(Wire.extra(data, FIELDS));
        return new GetPaymentLinkDocumentQuery(builder);
    }
     ...
     */
    public static GetPaymentLinkDocumentQuery fromJson(Object data) {
        return fromMap(Wire.object(data, "GetPaymentLinkDocumentQuery"));
    }
    ...
    public boolean equals(Object other) {
        return other instanceof GetPaymentLinkDocumentQuery that
    ...
    /** Builds a {@link GetPaymentLinkDocumentQuery}. */
    public static final class Builder {
        ...
        /**
         * @return the {@link GetPaymentLinkDocumentQuery}
         * @throws IllegalStateException when a required field is not set
         */
        public GetPaymentLinkDocumentQuery build() {
            Wire.require(this.uuid, "GetPaymentLinkDocumentQuery", "uuid");
            return new GetPaymentLinkDocumentQuery(this);
        }
    }
}

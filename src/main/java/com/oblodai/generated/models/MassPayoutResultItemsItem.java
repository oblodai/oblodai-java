 ...
 */
public final class MassPayoutResultItemsItem implements WireObject {
    ...
    private final PayoutItem result;
    private final Set<String> nulls;
    private final Map<String, Object> extra;

    private MassPayoutResultItemsItem(Builder builder) {
     ...
     */
    public static MassPayoutResultItemsItem fromMap(Map<String, ?> data) {
        Builder builder = new Builder();
        builder.errorCode = Wire.optional(
                data, "error_code", Wire::string, "MassPayoutResultItemsItem");
        builder.httpStatus = Wire.optional(
                data, "http_status", Wire::integer, "MassPayoutResultItemsItem");
        builder.idx = Wire.required(data, "idx", Wire::integer, "MassPayoutResultItemsItem");
        builder.message = Wire.optional(data, "message", Wire::string, "MassPayoutResultItemsItem");
        builder.ok = Wire.required(data, "ok", Wire::bool, "MassPayoutResultItemsItem");
        builder.orderId = Wire.optional(
                data, "order_id", Wire::string, "MassPayoutResultItemsItem");
        builder.result = Wire.optional(
                data, "result", PayoutItem::fromJson, "MassPayoutResultItemsItem");
        builder.nulls.addAll(Wire.nulls(data, FIELDS));
        builder.extra.putAll(Wire.extra(data, FIELDS));
        return new MassPayoutResultItemsItem(builder);
    }
     ...
     */
    public static MassPayoutResultItemsItem fromJson(Object data) {
        return fromMap(Wire.object(data, "MassPayoutResultItemsItem"));
    }
    ...
    public boolean equals(Object other) {
        return other instanceof MassPayoutResultItemsItem that
    ...
    /** Builds a {@link MassPayoutResultItemsItem}. */
    public static final class Builder {
         ...
         * @return this builder
         */
        public Builder result(PayoutItem result) {
            this.result = result;
            return this;
        }
        ...
        /**
         * @return the {@link MassPayoutResultItemsItem}
         * @throws IllegalStateException when a required field is not set
         */
        public MassPayoutResultItemsItem build() {
            Wire.require(this.idx, "MassPayoutResultItemsItem", "idx");
            Wire.require(this.ok, "MassPayoutResultItemsItem", "ok");
            return new MassPayoutResultItemsItem(this);
        }
    }
}

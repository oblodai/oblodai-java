 ...
 */
public final class AutoWithdrawSetRequest implements WireObject {
    ...
    private AutoWithdrawSetRequest(Builder builder) {
     ...
     */
    public static AutoWithdrawSetRequest fromMap(Map<String, ?> data) {
        Builder builder = new Builder();
        builder.address = Wire.required(data, "address", Wire::string, "AutoWithdrawSetRequest");
        builder.currency = Wire.required(data, "currency", Wire::string, "AutoWithdrawSetRequest");
        builder.minAmount = Wire.optional(
                data, "min_amount", Wire::string, "AutoWithdrawSetRequest");
        builder.network = Wire.required(data, "network", Wire::string, "AutoWithdrawSetRequest");
        builder.nulls.addAll(Wire.nulls(data, FIELDS));
        builder.extra.putAll(Wire.extra(data, FIELDS));
        return new AutoWithdrawSetRequest(builder);
    }
     ...
     */
    public static AutoWithdrawSetRequest fromJson(Object data) {
        return fromMap(Wire.object(data, "AutoWithdrawSetRequest"));
    }
    ...
    public boolean equals(Object other) {
        return other instanceof AutoWithdrawSetRequest that
    ...
    /** Builds a {@link AutoWithdrawSetRequest}. */
    public static final class Builder {
        ...
        /**
         * @return the {@link AutoWithdrawSetRequest}
         * @throws IllegalStateException when a required field is not set
         */
        public AutoWithdrawSetRequest build() {
            Wire.require(this.address, "AutoWithdrawSetRequest", "address");
            Wire.require(this.currency, "AutoWithdrawSetRequest", "currency");
            Wire.require(this.network, "AutoWithdrawSetRequest", "network");
            return new AutoWithdrawSetRequest(this);
        }
    }
}

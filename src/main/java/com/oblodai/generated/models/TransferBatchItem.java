 ...
 */
public final class TransferBatchItem implements WireObject {
    ...
    private TransferBatchItem(Builder builder) {
     ...
     */
    public static TransferBatchItem fromMap(Map<String, ?> data) {
        Builder builder = new Builder();
        builder.amount = Wire.required(data, "amount", Wire::decimal, "TransferBatchItem");
        builder.currency = Wire.required(data, "currency", Wire::string, "TransferBatchItem");
        builder.orderId = Wire.required(data, "order_id", Wire::string, "TransferBatchItem");
        builder.toUserId = Wire.required(data, "to_user_id", Wire::string, "TransferBatchItem");
        builder.nulls.addAll(Wire.nulls(data, FIELDS));
        builder.extra.putAll(Wire.extra(data, FIELDS));
        return new TransferBatchItem(builder);
    }
     ...
     */
    public static TransferBatchItem fromJson(Object data) {
        return fromMap(Wire.object(data, "TransferBatchItem"));
    }
    ...
    public boolean equals(Object other) {
        return other instanceof TransferBatchItem that
    ...
    /** Builds a {@link TransferBatchItem}. */
    public static final class Builder {
        ...
        /**
         * @return the {@link TransferBatchItem}
         * @throws IllegalStateException when a required field is not set
         */
        public TransferBatchItem build() {
            Wire.require(this.amount, "TransferBatchItem", "amount");
            Wire.require(this.currency, "TransferBatchItem", "currency");
            Wire.require(this.orderId, "TransferBatchItem", "order_id");
            Wire.require(this.toUserId, "TransferBatchItem", "to_user_id");
            return new TransferBatchItem(this);
        }
    }
}

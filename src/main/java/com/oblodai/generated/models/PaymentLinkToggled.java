 ...
 */
public final class PaymentLinkToggled implements WireObject {
    ...
    private PaymentLinkToggled(Builder builder) {
     ...
     */
    public static PaymentLinkToggled fromMap(Map<String, ?> data) {
        Builder builder = new Builder();
        builder.active = Wire.required(data, "active", Wire::bool, "PaymentLinkToggled");
        builder.linkId = Wire.required(data, "link_id", Wire::string, "PaymentLinkToggled");
        builder.nulls.addAll(Wire.nulls(data, FIELDS));
        builder.extra.putAll(Wire.extra(data, FIELDS));
        return new PaymentLinkToggled(builder);
    }
     ...
     */
    public static PaymentLinkToggled fromJson(Object data) {
        return fromMap(Wire.object(data, "PaymentLinkToggled"));
    }
    ...
    public boolean equals(Object other) {
        return other instanceof PaymentLinkToggled that
    ...
    /** Builds a {@link PaymentLinkToggled}. */
    public static final class Builder {
        ...
        /**
         * @return the {@link PaymentLinkToggled}
         * @throws IllegalStateException when a required field is not set
         */
        public PaymentLinkToggled build() {
            Wire.require(this.active, "PaymentLinkToggled", "active");
            Wire.require(this.linkId, "PaymentLinkToggled", "link_id");
            return new PaymentLinkToggled(this);
        }
    }
}

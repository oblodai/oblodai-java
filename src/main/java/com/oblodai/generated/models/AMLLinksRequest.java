 ...
 */
public final class AMLLinksRequest implements WireObject {
    ...
    private AMLLinksRequest(Builder builder) {
     ...
     */
    public static AMLLinksRequest fromMap(Map<String, ?> data) {
        Builder builder = new Builder();
        builder.orderId = Wire.optional(data, "order_id", Wire::string, "AMLLinksRequest");
        builder.uuid = Wire.optional(data, "uuid", Wire::string, "AMLLinksRequest");
        builder.nulls.addAll(Wire.nulls(data, FIELDS));
        builder.extra.putAll(Wire.extra(data, FIELDS));
        return new AMLLinksRequest(builder);
    }
     ...
     */
    public static AMLLinksRequest fromJson(Object data) {
        return fromMap(Wire.object(data, "AMLLinksRequest"));
    }
    ...
    public boolean equals(Object other) {
        return other instanceof AMLLinksRequest that
    ...
    public static final class Builder {
        ...
        /**
         * @return the {@link AMLLinksRequest}
         */
        public AMLLinksRequest build() {
            return new AMLLinksRequest(this);
        }
    }
}

 ...
 */
public final class PayoutValidateRequest implements WireObject {
    ...
    private PayoutValidateRequest(Builder builder) {
     ...
     */
    public static PayoutValidateRequest fromMap(Map<String, ?> data) {
        Builder builder = new Builder();
        builder.address = Wire.required(data, "address", Wire::string, "PayoutValidateRequest");
        builder.amount = Wire.required(data, "amount", Wire::decimal, "PayoutValidateRequest");
        builder.currency = Wire.required(data, "currency", Wire::string, "PayoutValidateRequest");
        builder.fromCurrency = Wire.optional(
                data, "from_currency", Wire::string, "PayoutValidateRequest");
        builder.isSubtract = Wire.optional(
                data, "is_subtract", Wire::bool, "PayoutValidateRequest");
        builder.memo = Wire.optional(data, "memo", Wire::string, "PayoutValidateRequest");
        builder.network = Wire.optional(data, "network", Wire::string, "PayoutValidateRequest");
        builder.orderId = Wire.optional(data, "order_id", Wire::string, "PayoutValidateRequest");
        builder.source = Wire.optional(data, "source", Wire::string, "PayoutValidateRequest");
        builder.urlCallback = Wire.optional(
                data, "url_callback", Wire::string, "PayoutValidateRequest");
        builder.nulls.addAll(Wire.nulls(data, FIELDS));
        builder.extra.putAll(Wire.extra(data, FIELDS));
        return new PayoutValidateRequest(builder);
    }
     ...
     */
    public static PayoutValidateRequest fromJson(Object data) {
        return fromMap(Wire.object(data, "PayoutValidateRequest"));
    }
    ...
    public boolean equals(Object other) {
        return other instanceof PayoutValidateRequest that
    ...
    /** Builds a {@link PayoutValidateRequest}. */
    public static final class Builder {
        ...
        /**
         * @return the {@link PayoutValidateRequest}
         * @throws IllegalStateException when a required field is not set
         */
        public PayoutValidateRequest build() {
            Wire.require(this.address, "PayoutValidateRequest", "address");
            Wire.require(this.amount, "PayoutValidateRequest", "amount");
            Wire.require(this.currency, "PayoutValidateRequest", "currency");
            return new PayoutValidateRequest(this);
        }
    }
}

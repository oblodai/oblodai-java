 ...
 */
public final class PaymentBatchItem implements WireObject {
    ...
    private PaymentBatchItem(Builder builder) {
     ...
     */
    public static PaymentBatchItem fromMap(Map<String, ?> data) {
        Builder builder = new Builder();
        builder.accuracyPaymentPercent = Wire.optional(
                data, "accuracy_payment_percent", Wire::number, "PaymentBatchItem");
        builder.additionalData = Wire.optional(
                data, "additional_data", Wire::string, "PaymentBatchItem");
        builder.amount = Wire.required(data, "amount", Wire::decimal, "PaymentBatchItem");
        builder.currency = Wire.required(data, "currency", Wire::string, "PaymentBatchItem");
        builder.isPaymentMultiple = Wire.optional(
                data, "is_payment_multiple", Wire::bool, "PaymentBatchItem");
        builder.isRefresh = Wire.optional(data, "is_refresh", Wire::bool, "PaymentBatchItem");
        builder.lifetimeSeconds = Wire.optional(
                data, "lifetime_seconds", Wire::integer, "PaymentBatchItem");
        builder.network = Wire.optional(data, "network", Wire::string, "PaymentBatchItem");
        builder.orderId = Wire.required(data, "order_id", Wire::string, "PaymentBatchItem");
        builder.payerEmail = Wire.optional(data, "payer_email", Wire::string, "PaymentBatchItem");
        builder.subtract = Wire.optional(data, "subtract", Wire::integer, "PaymentBatchItem");
        builder.theme = Wire.optional(data, "theme", Wire::string, "PaymentBatchItem");
        builder.toCurrency = Wire.optional(data, "to_currency", Wire::string, "PaymentBatchItem");
        builder.urlCallback = Wire.optional(data, "url_callback", Wire::string, "PaymentBatchItem");
        builder.urlReturn = Wire.optional(data, "url_return", Wire::string, "PaymentBatchItem");
        builder.urlSuccess = Wire.optional(data, "url_success", Wire::string, "PaymentBatchItem");
        builder.nulls.addAll(Wire.nulls(data, FIELDS));
        builder.extra.putAll(Wire.extra(data, FIELDS));
        return new PaymentBatchItem(builder);
    }
     ...
     */
    public static PaymentBatchItem fromJson(Object data) {
        return fromMap(Wire.object(data, "PaymentBatchItem"));
    }
    ...
    public boolean equals(Object other) {
        return other instanceof PaymentBatchItem that
    ...
    /** Builds a {@link PaymentBatchItem}. */
    public static final class Builder {
        ...
        /**
         * @return the {@link PaymentBatchItem}
         * @throws IllegalStateException when a required field is not set
         */
        public PaymentBatchItem build() {
            Wire.require(this.amount, "PaymentBatchItem", "amount");
            Wire.require(this.currency, "PaymentBatchItem", "currency");
            Wire.require(this.orderId, "PaymentBatchItem", "order_id");
            return new PaymentBatchItem(this);
        }
    }
}

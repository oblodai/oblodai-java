 ...
 */
public final class SoFSubmitted implements WireObject {
    ...
    private SoFSubmitted(Builder builder) {
     ...
     */
    public static SoFSubmitted fromMap(Map<String, ?> data) {
        Builder builder = new Builder();
        builder.accepted = Wire.required(data, "accepted", Wire::bool, "SoFSubmitted");
        builder.status = Wire.required(data, "status", SoFStatus::fromJson, "SoFSubmitted");
        builder.nulls.addAll(Wire.nulls(data, FIELDS));
        builder.extra.putAll(Wire.extra(data, FIELDS));
        return new SoFSubmitted(builder);
    }
     ...
     */
    public static SoFSubmitted fromJson(Object data) {
        return fromMap(Wire.object(data, "SoFSubmitted"));
    }
    ...
    public boolean equals(Object other) {
        return other instanceof SoFSubmitted that
    ...
    public static final class Builder {
        ...
        /**
         * @return the {@link SoFSubmitted}
         * @throws IllegalStateException when a required field is not set
         */
        public SoFSubmitted build() {
            Wire.require(this.accepted, "SoFSubmitted", "accepted");
            Wire.require(this.status, "SoFSubmitted", "status");
            return new SoFSubmitted(this);
        }
    }
}

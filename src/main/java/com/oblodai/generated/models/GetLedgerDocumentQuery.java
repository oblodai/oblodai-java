...
/**
 * Query parameters of {@code GET /v1/documents/ledger}.
 *
 * <p>Build one with {@link #builder()}; fields the SDK does not know yet are kept in
 * {@link #extra()} and sent back as they came.
 */
public final class GetLedgerDocumentQuery implements WireObject {
    ...
    private GetLedgerDocumentQuery(Builder builder) {
     ...
     */
    public static GetLedgerDocumentQuery fromMap(Map<String, ?> data) {
        Builder builder = new Builder();
        builder.from = Wire.optional(data, "from", Wire::string, "GetLedgerDocumentQuery");
        builder.to = Wire.optional(data, "to", Wire::string, "GetLedgerDocumentQuery");
        builder.lang = Wire.optional(data, "lang", Wire::string, "GetLedgerDocumentQuery");
        builder.format = Wire.optional(data, "format", Wire::string, "GetLedgerDocumentQuery");
        builder.nulls.addAll(Wire.nulls(data, FIELDS));
        builder.extra.putAll(Wire.extra(data, FIELDS));
        return new GetLedgerDocumentQuery(builder);
    }
     ...
     */
    public static GetLedgerDocumentQuery fromJson(Object data) {
        return fromMap(Wire.object(data, "GetLedgerDocumentQuery"));
    }
    ...
    public boolean equals(Object other) {
        return other instanceof GetLedgerDocumentQuery that
    ...
    /** Builds a {@link GetLedgerDocumentQuery}. */
    public static final class Builder {
        ...
        /**
         * @return the {@link GetLedgerDocumentQuery}
         */
        public GetLedgerDocumentQuery build() {
            return new GetLedgerDocumentQuery(this);
        }
    }
}

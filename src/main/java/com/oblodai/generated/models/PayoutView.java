 ...
 */
public final class PayoutView implements WireObject {
    ...
    private PayoutView(Builder builder) {
     ...
     */
    public static PayoutView fromMap(Map<String, ?> data) {
        Builder builder = new Builder();
        builder.address = Wire.required(data, "address", Wire::string, "PayoutView");
        builder.amount = Wire.required(data, "amount", Wire::decimal, "PayoutView");
        builder.approvalRequired = Wire.required(
                data, "approval_required", Wire::bool, "PayoutView");
        builder.commission = Wire.required(data, "commission", Wire::decimal, "PayoutView");
        builder.createdAt = Wire.required(data, "created_at", Wire::string, "PayoutView");
        builder.currency = Wire.required(data, "currency", Wire::string, "PayoutView");
        builder.documentUrl = Wire.required(data, "document_url", Wire::string, "PayoutView");
        builder.feeBearer = Wire.required(
                data, "fee_bearer", PayoutFeeBearer::fromJson, "PayoutView");
        builder.isFinal = Wire.required(data, "is_final", Wire::bool, "PayoutView");
        builder.isRefund = Wire.required(data, "is_refund", Wire::bool, "PayoutView");
        builder.memo = Wire.required(data, "memo", Wire::string, "PayoutView");
        builder.network = Wire.required(data, "network", Wire::string, "PayoutView");
        builder.orderId = Wire.optional(data, "order_id", Wire::string, "PayoutView");
        builder.payerAmount = Wire.required(data, "payer_amount", Wire::decimal, "PayoutView");
        builder.paymentOrderId = Wire.optional(
                data, "payment_order_id", Wire::string, "PayoutView");
        builder.refundFor = Wire.optional(data, "refund_for", Wire::string, "PayoutView");
        builder.source = Wire.required(data, "source", PayoutSource::fromJson, "PayoutView");
        builder.status = Wire.required(data, "status", PayoutStatus::fromJson, "PayoutView");
        builder.txid = Wire.required(data, "txid", Wire::string, "PayoutView");
        builder.updatedAt = Wire.required(data, "updated_at", Wire::string, "PayoutView");
        builder.uuid = Wire.required(data, "uuid", Wire::string, "PayoutView");
        builder.nulls.addAll(Wire.nulls(data, FIELDS));
        builder.extra.putAll(Wire.extra(data, FIELDS));
        return new PayoutView(builder);
    }
     ...
     */
    public static PayoutView fromJson(Object data) {
        return fromMap(Wire.object(data, "PayoutView"));
    }
    ...
    public boolean equals(Object other) {
        return other instanceof PayoutView that
    ...
    public static final class Builder {
        ...
        /**
         * @return the {@link PayoutView}
         * @throws IllegalStateException when a required field is not set
         */
        public PayoutView build() {
            Wire.require(this.address, "PayoutView", "address");
            Wire.require(this.amount, "PayoutView", "amount");
            Wire.require(this.approvalRequired, "PayoutView", "approval_required");
            Wire.require(this.commission, "PayoutView", "commission");
            Wire.require(this.createdAt, "PayoutView", "created_at");
            Wire.require(this.currency, "PayoutView", "currency");
            Wire.require(this.documentUrl, "PayoutView", "document_url");
            Wire.require(this.feeBearer, "PayoutView", "fee_bearer");
            Wire.require(this.isFinal, "PayoutView", "is_final");
            Wire.require(this.isRefund, "PayoutView", "is_refund");
            Wire.require(this.memo, "PayoutView", "memo");
            Wire.require(this.network, "PayoutView", "network");
            Wire.require(this.payerAmount, "PayoutView", "payer_amount");
            Wire.require(this.source, "PayoutView", "source");
            Wire.require(this.status, "PayoutView", "status");
            Wire.require(this.txid, "PayoutView", "txid");
            Wire.require(this.updatedAt, "PayoutView", "updated_at");
            Wire.require(this.uuid, "PayoutView", "uuid");
            return new PayoutView(this);
        }
    }
}

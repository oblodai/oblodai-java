 ...
 */
public final class VRCSRequest implements WireObject {
    ...
    private VRCSRequest(Builder builder) {
     ...
     */
    public static VRCSRequest fromMap(Map<String, ?> data) {
        Builder builder = new Builder();
        builder.enabled = Wire.optional(data, "enabled", Wire::bool, "VRCSRequest");
        builder.nulls.addAll(Wire.nulls(data, FIELDS));
        builder.extra.putAll(Wire.extra(data, FIELDS));
        return new VRCSRequest(builder);
    }
     ...
     */
    public static VRCSRequest fromJson(Object data) {
        return fromMap(Wire.object(data, "VRCSRequest"));
    }
    ...
    public boolean equals(Object other) {
        return other instanceof VRCSRequest that
    ...
    public static final class Builder {
        ...
        /**
         * @return the {@link VRCSRequest}
         */
        public VRCSRequest build() {
            return new VRCSRequest(this);
        }
    }
}

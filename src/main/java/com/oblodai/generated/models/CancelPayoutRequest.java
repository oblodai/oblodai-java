 ...
 */
public final class CancelPayoutRequest implements WireObject {
    ...
    private CancelPayoutRequest(Builder builder) {
     ...
     */
    public static CancelPayoutRequest fromMap(Map<String, ?> data) {
        Builder builder = new Builder();
        builder.uuid = Wire.required(data, "uuid", Wire::string, "CancelPayoutRequest");
        builder.nulls.addAll(Wire.nulls(data, FIELDS));
        builder.extra.putAll(Wire.extra(data, FIELDS));
        return new CancelPayoutRequest(builder);
    }
     ...
     */
    public static CancelPayoutRequest fromJson(Object data) {
        return fromMap(Wire.object(data, "CancelPayoutRequest"));
    }
    ...
    public boolean equals(Object other) {
        return other instanceof CancelPayoutRequest that
    ...
    /** Builds a {@link CancelPayoutRequest}. */
    public static final class Builder {
        ...
        /**
         * @return the {@link CancelPayoutRequest}
         * @throws IllegalStateException when a required field is not set
         */
        public CancelPayoutRequest build() {
            Wire.require(this.uuid, "CancelPayoutRequest", "uuid");
            return new CancelPayoutRequest(this);
        }
    }
}

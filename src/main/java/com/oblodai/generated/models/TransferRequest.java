 ...
 */
public final class TransferRequest implements WireObject {
     ...
     */
    public static TransferRequest fromMap(Map<String, ?> data) {
        Builder builder = new Builder();
        builder.amount = Wire.required(data, "amount", Wire::decimal, "TransferRequest");
        builder.currency = Wire.required(data, "currency", Wire::string, "TransferRequest");
        builder.orderId = Wire.optional(data, "order_id", Wire::string, "TransferRequest");
     ...
     */
    public static TransferRequest fromJson(Object data) {
        return fromMap(Wire.object(data, "TransferRequest"));
    }
    ...
    public boolean equals(Object other) {
        return other instanceof TransferRequest that
    ...
    public static final class Builder {
        ...
        /**
         * @return the {@link TransferRequest}
         * @throws IllegalStateException when a required field is not set
         */
        public TransferRequest build() {
            Wire.require(this.amount, "TransferRequest", "amount");
            Wire.require(this.currency, "TransferRequest", "currency");

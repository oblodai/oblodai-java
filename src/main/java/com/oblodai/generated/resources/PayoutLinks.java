...
public final class PayoutLinks extends Resource {
     ...
     * @return the result
     */
    public PayoutLinkCreated create(PayoutLinkItem params, RequestOptions options) {
        return call(
     ...
     * @return the result
     */
    public PayoutLinkCreated create(PayoutLinkItem params) {
     ...
     * @return the result
     */
    public PayoutLinkBatchResult createBatch(
     ...
     * @return the result
     */
    public PayoutLinkBatchResult createBatch(PayoutLinkBatchRequest params) {
     ...
     */
    public Pager<PayoutLinkView> list(PageRequest params, RequestOptions options) {
        return paged(
     ...
     * @return a lazy pager over every item; nothing is requested until it is consumed
     */
    public Pager<PayoutLinkView> list(PageRequest params) {
     ...
     * @return a lazy pager over every item; nothing is requested until it is consumed
     */
    public Pager<PayoutLinkView> list(RequestOptions options) {
     ...
     * @return a lazy pager over every item; nothing is requested until it is consumed
     */
    public Pager<PayoutLinkView> list() {
     ...
     * @return the result
     */
    public PayoutLinkView get(PayoutLinkIDRequest params, RequestOptions options) {
        return call(
     ...
     * @return the result
     */
    public PayoutLinkView get(PayoutLinkIDRequest params) {
     ...
     * @return the result
     */
    public PayoutLinkView cancel(PayoutLinkIDRequest params, RequestOptions options) {
        return call(
     ...
     * @return the result
     */
    public PayoutLinkView cancel(PayoutLinkIDRequest params) {
     ...
     * @return the result
     */
    public PayoutClaimInfo getPayoutClaim(String token, RequestOptions options) {
        return call(
     ...
     * @return the result
     */
    public PayoutClaimInfo getPayoutClaim(String token) {
     ...
     * @return the result
     */
    public PayoutClaimed claimPayout(String token, ClaimRequest params, RequestOptions options) {
        return call(
                Routes.CLAIM_PAYOUT,
                Wire.path("token", token),
                null,
     ...
     * @return the result
     */
    public PayoutClaimed claimPayout(String token, ClaimRequest params) {

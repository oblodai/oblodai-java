 ...
 *
 * <p>The {@code Referrals} resource: one method per API operation. Every method takes per-call
...
public final class Referrals extends Resource {
     ...
     * @return the result
     */
    public ReferralInfoResult getInfo(RequestOptions options) {
        return call(
     ...
     * @return the result
     */
    public ReferralInfoResult getInfo() {
        return getInfo(null);
    }
}

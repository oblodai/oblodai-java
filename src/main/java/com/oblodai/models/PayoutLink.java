 ...
 * @param claimToken present on create and batch-create only — the secret the recipient claims with
 * @param claimUrl present on create and batch-create only — the ready-made claim link
